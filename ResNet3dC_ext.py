...
First modified by CWRU Tue Jul 1 01:55:00Z 2020
...
class MeanSquare3d(nn.Module):
    '''
    Mean-square averaging layer. Converts a 3d input to a 2d output.
    '''
    def __init__(self, Cin, Cout):
        super(MeanSquare3d, self).__init__()
